...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "iwa_2022-kafka-1:9092");
    ...
    public ConsumerFactory<String, Offer> offerConsumerFactory() {
        ...
        JsonDeserializer jsonDeserializer = new JsonDeserializer<>(Offer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Offer> offerKafkaListenerFactory() {
